...
public class EASSInfraRedSensor implements EASSSensor
{
	...
	public EASSInfraRedSensor(RemoteRequestEV3 brick, String portName) throws Exception
	{ //was remote exception
		sensor = (RemoteRequestSampleProvider) brick.createSampleProvider(portName, "lejos.hardware.sensor.EV3IRSensor", "Distance");
	}
	...
	public void addPercept(EASSEV3Environment env) {
		try {
			...
			// Convert to metres so output is consistent with Ultrasonic sensor output.
			distancevalue = 5;
			if (out != null) {
